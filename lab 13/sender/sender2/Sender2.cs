...
public class Sender2
{
    ...
    public static void Main()
    {
        ...
        {
            string message = JsonConvert.SerializeObject(new { message = "Filip", time = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"), counter = counter++ });
            ...
            int sleep = random.Next(750, 1250);
            Thread.Sleep(sleep);
        }
